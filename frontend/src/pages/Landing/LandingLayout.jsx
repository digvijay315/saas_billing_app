        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          >
            ...
            <button 
              ...
              className="px-6 py-2.5 rounded-full bg-blue-600 text-white text-sm font-bold hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/20 transition-all transform hover:scale-105"
            >
              Get Started
            </button>
          </motion.div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-2 flex flex-col">
              ...
              <button 
                onClick={() => { closeMobileMenu(); setRegisterModalOpen(true); }}
                className="w-full text-center px-4 py-4 mt-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-slate-900 text-lg font-black hover:from-cyan-400 hover:to-blue-400 transition-all shadow-lg shadow-cyan-500/20"
              >
                Get Started
              </button>
            </div>
