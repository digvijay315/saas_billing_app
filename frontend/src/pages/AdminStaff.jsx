      ...
      <div className="flex-1 flex flex-col gap-6 min-w-0">
        <div className="glass-card rounded-2xl p-6 flex flex-col gap-4">
          <div className="flex items-center gap-2 border-b border-slate-800 pb-4">
            ...
            <div>
              <h2 className="font-bold text-sm text-slate-100">Registered Staff Accounts</h2>
              <p className="text-[10px] text-slate-500">Manage credentials and profile registries for hotel billing staff</p>
            </div>
          </div>
